...
volatile int flag_enviar_dados = 0;

void Leds_Off(){ RB1=0; RB2=0; RB4=0; RB5=0; RB3=0; }
...
void Lcd_Write_String(char *a){ int i; for(i=0;a[i]!='\0';i++){ char t=a[i]&0x0F,y=a[i]&0xF0;RD2=1;Lcd_Port(y>>4);RD3=1;_delay((unsigned long)((40)*(20000000/4000000.0)));RD3=0;Lcd_Port(t);RD3=1;_delay((unsigned long)((40)*(20000000/4000000.0)));RD3=0; } }
...
void UART_Init(long baud){ SPBRG=(unsigned char)((20000000/(16*baud))-1); TXSTAbits.BRGH=1; TXSTAbits.TXEN=1; RCSTAbits.CREN=1; RCSTAbits.SPEN=1; }
...
unsigned int ADC_Read(){ GO_nDONE=1; while(GO_nDONE) __asm("clrwdt"); return((ADRESH<<8)+ADRESL); }
...
void main(){
    ...
    while(1){
        ...
        if(!trancado){
            int pot = ADC_Read();
            kmh_simulado = (int)((unsigned long)pot * 220 / 1023);
